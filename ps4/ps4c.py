...
class SubMessage(object):
    ...
    def apply_transpose(self, transpose_dict):
        ...
        for letter in self.get_message_text():
            if letter.isalpha():
                encrypted_message.append(transpose_dict[letter])
            else:
...
class EncryptedSubMessage(SubMessage):
    ...
    def decrypt_message(self):
        ...
        for permutation in vowels_permutations:
            ...
            cur_decrypt = self.apply_transpose(transpose_dict)
        ...
        if best_score == 0:
            ...
            best_dict = self.build_transpose_dict(best_permutation)
            best_decrypt = self.apply_transpose(best_dict)
...
if __name__ == '__main__':
    ...
    message = SubMessage("love you")
    permutation = "eoiua"
    enc_dict = message.build_transpose_dict(permutation)
    print("Original message:", message.get_message_text(), "Permutation:", permutation)
    print("Expected encryption:", "luvo yia")
    print("Actual encryption:", message.apply_transpose(enc_dict))
    enc_message = EncryptedSubMessage(message.apply_transpose(enc_dict))
    print("Decrypted message:", enc_message.decrypt_message())
